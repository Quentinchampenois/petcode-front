            ...
            if (r.ok) {
                navigate("/dashboard/profile", {
                    replace: true, state: {
                        flash: {
                            open: true,
                            message: `Les informations de ${name.value} ont bien été enregistrées`,
                            severity: "success"
                        }
                    }
                })
                ...
                setSnack({
                    open: true,
                    message: `Une erreur est survenue lors de l'enregistrement des informations de ${name.value}`,
                    severity: "error"
                })
